...
plt.annotate(f'Final mass flux value: {round(mass_flux_arr[-1],1)}', xy = (1,2.95), bbox=dict(facecolor="white", edgecolor="black", boxstyle="round,pad=0.3"))
plt.annotate(f'Final momentum flux value: {round(momentum_flux_arr[-1],2)}', xy = (1,2.7), bbox=dict(facecolor="white", edgecolor="black", boxstyle="round,pad=0.3"))
plt.annotate(f'Final energy flux value: {round(energy_flux_arr[-1],2)}', xy = (1, 2.45), bbox=dict(facecolor="white", edgecolor="black", boxstyle="round,pad=0.3"))
plt.legend()
plt.grid(True)
